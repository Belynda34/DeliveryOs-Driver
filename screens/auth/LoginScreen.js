...
export default function LoginScreen() {
  ...
  const enterDemo = () => setUser({ id: 'demo-driver', name: 'Alex Morgan' });
    ...
    <KeyboardAvoidingView className="flex-1 bg-slate-50" behavior="padding">
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="mx-auto w-full max-w-xl flex-1 justify-between px-6 pb-8 pt-20">
          ...
          <Text className="mt-8 text-center text-xs leading-5 text-slate-400">UI demo only — authentication will be connected later.</Text>
        </View>
      </ScrollView>
